...
all_client_sources =  $(addprefix Client/edu/rice/rubbos/client/, $(addsuffix .java, $(ClientFiles)))
all_client_obj = $(addprefix Client/edu/rice/rubbos/client/, $(addsuffix .class, $(ClientFiles))) edu/rice/rubbos/beans/TimeManagement.class
...
emulator:
	${JAVA} -Xss228k -Xmx2048m -classpath .:Client/rubbos_client.jar edu.rice.rubbos.client.ClientEmulator
